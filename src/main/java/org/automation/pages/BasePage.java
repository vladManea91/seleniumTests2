...
public class BasePage {
  ...
  protected void click(By by, String elementNameForReport) {
	...
	protected void sendKeysButton(By by) {
		DriverManager.getDriver().findElement(by).sendKeys(Keys.RETURN);
	}
	...
	protected void pageSource(String value) {
		DriverManager.getDriver().getPageSource().contains(value);
	}
